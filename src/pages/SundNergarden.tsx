...
const SundNergarden = () => {
  return (
    <>
    <ShowProject mobile={sundMobile} mobileW={sundMobileW} desktop={sundDesk} desktopW={sundDeskW} header='Sund Nergården' fontFamily='"Satisfy"' fontSize='2.5rem' padding='0.3rem' website='sund nergården' url='https://demosundnergarden.netlify.app/'
    aboutText='
